...
export const recetas: Receta[] = [
  ...
  },
  {
    ...
    instrucciones: [
      "Manteca de ají: clarificar la manteca. Cuando esté lista agregar el ají molido para infusionar. Volcar en un GN 1/1 y luego porcionar en bloques de 500 grs.",
      "Gel de xantana: poner el agua fría en la licuadora, agregar la goma xántica de golpe y procesar hasta que quede hecha una pasta. Conservar en heladera.",
      "Poner las yemas en thermomix y llevar a 65 grados durante 6 minutos. Cuando las yemas estén aireadas, emulsionar con la manteca en forma de hilo.",
      "Agregar todo el Grupo B, rectificar de sal si es necesario. Por último agregar el gel. Reservar en servicio a temperatura ambiente.",
    ],
  ...
  },
  {
    ...
    instrucciones: [
      "Brine: en una olla, llevar el Brine A al fuego hasta disolver. Una vez la salmuera ya disuelta agregar el Brine B y reservar hasta enfriar. Agregar las pechugas de pollo y dejar en brine 24 hs.",
  ...
  },
  {
    ...
    instrucciones: [
      "Ablandar el queso crema batiéndolo en kitchen aid o a mano.",
      "Unir todo lo demás.",
    ],
  },
  {
    ...
    instrucciones: [
      "Mezclar todo en biberón directo y dejar reposar 2 hs.",
  ...
  },
  {
    ...
    instrucciones: [
      "Pelar las remolachas. Lavar. Rallar a mano.",
      "Colocar en una olla las remolachas ralladas, el azúcar, el vinagre y el agua. Llevar a hervor y bajar el fuego. Cocinar hasta que la remolacha esté bien hecha.",
  ...
  },
  {
    ...
    ingredientes: [
      ...
      { nombre: "Azúcar mascabo", cantidad: 32, unidad: "tbsp", grupo: "Grupo C" },
    ...
    instrucciones: [
      "Limpiar la lisa removiendo escamas y vísceras. Filetear y sacar las espinas de cada filet. Reservar el pescado y guardar las espinas y cabezas para otras preparaciones.",
      "Hacer una salmuera con el Grupo B y enfriar a 4 grados antes de usar.",
      "Sumergir los filetes de lisa en la salmuera y reservar tapado en heladera por 24 hs.",
      ...
      "Colocar los filetes en el vinagre especiado. Sellar al vacío y reservar en heladera 48 hs, mover cada 12 hs los filetes para que todos estén en contacto con el vinagre, por lo menos 24 hs.",
  ...
  },
  {
    ...
    instrucciones: [
      "Poner el Grupo A en licuadora, licuar.",
  ...
  },
  {
    ...
    instrucciones: [
      "Procesar todo junto en thermomix hasta que quede como un arenado.",
      "Pasar a placa y llevar a horno 150°C, revolviendo cada 10 minutos hasta que esté dorado y crocante.",
    ],
  },
  {
    id: "41",
    ...
    instrucciones: [
      ...
      "Pasar por chino fino. DURA 3 DÍAS.",
    ],
    notas: "Dura 3 días.",
  },
  {
  ...
  },
  {
    ...
    ingredientes: [
      ...
      { nombre: "Pasa de uva negra", cantidad: 6, unidad: "g", grupo: "Grupo B" },
      ...
      { nombre: "Ají molido", cantidad: 0.5, unidad: "tbsp", grupo: "Grupo B" },
      { nombre: "Nuez moscada", cantidad: 0.25, unidad: "tbsp", grupo: "Grupo B" },
      { nombre: "Jengibre fresco", cantidad: 15, unidad: "g", grupo: "Grupo B" },
      { nombre: "Vinagre de manzana", cantidad: 150, unidad: "g", grupo: "Grupo B" },
      { nombre: "Sal", cantidad: 0.5, unidad: "tbsp", grupo: "Grupo B" },
    ],
    instrucciones: [
  ...
  },
  {
    ...
    instrucciones: [
      "Unir todo en una olla y reducir a fuego medio hasta casi glaza. Enfriar a temperatura ambiente.",
    ],
  ...
  },
  {
    ...
    instrucciones: [
      ...
      "Agregar la carne marcada, y desglasar con el vino y el cognac y dejar evaporar el alcohol.",
      "Ir agregando caldo de a poco hasta que la carne esté bien tierna. Agregar de a poco y volver a agregar caldo cuando se haya evaporado el líquido.",
  ...
  },
  {
    ...
    instrucciones: [
      ...
      "Levantar de nuevo la temperatura de la olla y agregar un poco de aceite si hace falta. Dorar a fuego fuerte las cabezas y carcasas de langostinos sin apilar. Si hace falta dorarlo en tandas. Cuando estén doradas machacar fuerte para que suelten todo el coral.",
      "Agregar en la olla las espinas doradas, los tomates quemados, el anís y las semillas de hinojo.",
      "Mojar todo con fumet blanco apenas hasta cubrir y subir el fuego para que rompa el hervor.",
      "Cuando hierva bajar el fuego y espumar. Cocinar durante 40 minutos.",
      "Cuando pase el tiempo volver a machacar para largar el colágeno que queda en las espinas y colar por chino fino.",
  ...
  },
  {
    ...
    instrucciones: [
      ...
      "Hacer una mirepoix de cebolla, zanahoria y apio. Cortar los tomates en pedazos medianos. Armar un bouquet garnie con dos hojas de laurel, dos ramas de romero y un poco de perejil. Envolver en un verde de puerro o directamente con un hilo para poder sacar después.",
      ...
      "Cuando los tomates hayan evaporado todo el agua agregar el vino tinto y rascar bien el fondo de la olla para terminar de levantar todo. Reducir el vino y agregar el bouquet garnie, los hongos secos, las carcasas, las alitas y las manitas de cerdo. Agregar los 20 litros de agua y llevar a fuego fuerte hasta hervor.",
      "Desglasar si hace falta las fuentes de horno de las carcasas y las alitas para levantar toda esa caramelización y agregar al fondo. Se puede usar un poco del vino de la receta o agua. Lo importante es no perder ese sabor del fondo de la bandeja. Si está quemado NO VA.",
      ...
      "Pasadas las 8 horas colar por chino y después por fino para que no quede ningún sólido. Enfriar en cámara por lo menos 12 horas, idealmente 24 horas. NUNCA poner el cambro o la olla directo al piso de la cámara: poner aros o algo para que no esté en contacto con el piso.",
      ...
      "Cuando está en su punto reservar en un cambro con film a piel (sino se le forma una capa fea como a la salsa blanca) y tapa.",
    ],
  ...
  },
  {
    ...
    instrucciones: [
      ...
      "Fuera del fuego ir agregando la leche de a poco, para evitar grumos. Una vez incorporada volver a fuego medio a cocinar por 3 mins.",
